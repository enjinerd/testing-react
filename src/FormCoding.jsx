...
export default function NameForm() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className={styles.centerForm} data-testid="form_regis">
      <label>
        Nama Lengkap:
        <input
          required
      ...
      <br/>
      <br/>
      <input type="submit" value="Submit" data-testid="btn_submit"/>
